...
describe('ProductGrid Component', () => {
  it('debe mostrar el spinner y mensaje de carga cuando loading es true', () => {
    renderWithRouter(<ProductGrid products={[]} loading={true} error={null} />);
  ...
  it('debe mostrar el mensaje de error cuando ocurre un fallo', () => {
    renderWithRouter(<ProductGrid products={[]} loading={false} error="Error de servidor" />);
  ...
  it('debe mostrar el estado vacío cuando no hay productos', () => {
    renderWithRouter(<ProductGrid products={[]} loading={false} error={null} />);
    
    expect(screen.getByText(/no se encontraron productos/i)).toBeInTheDocument();
  });

  it('debe renderizar la lista de productos correctamente cuando hay datos', () => {
    renderWithRouter(<ProductGrid products={mockProducts} loading={false} error={null} />);
